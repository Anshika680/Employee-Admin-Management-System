...
const AllTask = () => {
    ...
    return (
        <div className='bg-[#1e1e1e] rounded-xl shadow-md shadow-black/10 p-6 mt-6'>
            <h2 className='text-3xl font-bold text-gray-100 mb-6'>Task Overview</h2>
            <div className='bg-black mb-4 py-3 px-6 flex justify-between rounded-lg'>
                <h2 className='w-1/5 font-semibold text-2xl  text-gray-300'>Employee Name</h2>
                <h3 className='w-1/5 text-2xl font-semibold text-center text-gray-300'>New Task</h3>
                <h5 className='w-1/5 text-2xl font-semibold text-center text-gray-300'>Active Task</h5>
                <h5 className='w-1/5 text-2xl font-semibold text-center text-gray-300'>Completed</h5>
                <h5 className='w-1/5 text-2xl font-semibold text-center text-gray-300'>Failed</h5>
            </div>
